...
当被动检测怀疑某个 IP 和端口在运行代理服务时，GFW 会从多个境内 IP 主动向这台服务器发起连接，模拟一个真实客户端"敲门"，再根据服务器的响应方式（是否响应、响应内容、连接行为特征）事后判断这是否真的是代理服务器。这一层是主动而非被动的，也更具针对性——学术研究已明确记录这一机制历史上曾被用于针对 Tor 网桥和 SoftEther VPN[^1][^2]。
...
- **在实际执法层面**：单纯"使用"本身通常很少作为唯一处罚依据——公开报道的案例中，处罚通常伴随其他行为，比如公开传播或售卖翻墙工具和账号、利用翻墙从事其他被认定为违法的活动、或访问、传播被认定为违法的内容。**下面这个真实案例可以说明这一点**：国家安全部微信公众号2025年11月披露过一起案例，某国企员工因**长期访问境外反华网站，观看涉政治谣言视频并下载传播**，被国家安全机关依法**逮捕**[^3]——需要注意，这起案例对应的行为是"访问特定境外网站+观看下载传播特定内容"这一组合行为，处理结果是刑事层面的逮捕，而不是单纯因为"长期使用翻墙工具"本身受到内部纪律处分；这个区分很重要，不应简化为"只要长期翻墙就会被抓"。
- **2025 年 11 月的官方表态**：国家安全部通过其官方微信公众号发文《"翻墙"？假猎奇，真危险》，明确写道"使用'翻墙'软件，本身已违反我国相关法律法规"，并公开提醒非法使用翻墙软件访问境外网站存在法律和安全风险[^3]。这是一次相对少见的、专门针对个人翻墙使用的官方表态，措辞比以往更直接，可以视为监管口径趋严的一个信号。
...
- 访问、观看、下载或传播被认定为违法的内容（如境外反华网站的政治谣言类信息）——如上文引用的真实案例所示，这类复合行为的风险明显高于单纯的连接行为本身
...
[^1]: Tor Project 官方博客关于GFW主动探测机制的技术分析，确认该系统曾针对Tor网桥、SoftEther和GoAgent等多种翻墙工具：https://blog.torproject.org/learning-more-about-gfws-active-probing-system/
[^2]: 学术论文《Examining How the Great Firewall Discovers Hidden Circumvention Servers》（ACM IMC 2015），详细记录了GFW对Tor与SoftEther VPN握手特征的主动探测实验数据：https://conferences.sigcomm.org/imc/2015/papers/p445.pdf
[^3]: 国家安全部微信公众号《"翻墙"？假猎奇，真危险》（2025年11月10日），案例细节与官方表态原文，参见转载报道：中新网 https://www.chinanews.com.cn/sh/2025/11-10/10512937.shtml ；安全内参（转载官方公众号原文，含案例完整表述）https://www.secrss.com/articles/84855?app=1

*本文最后一次事实核查：2026-08-05。核查过程见项目对话记录。本次核查重点修正了"国企员工"案例的表述——原文将其简化为"长期单纯使用翻墙被处分"，经核对官方原始信源后改为贴近原始报道的表述（访问反华网站+观看下载传播政治谣言视频+依法逮捕），避免因简化而误导读者对实际风险等级的判断。*
